    ...
    return (
        <div className='my-20'>
            ...
            <div  className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 w-2/3 mx-auto'>
                <div data-aos="fade-right" className='bg-pink-100 p-4 rounded-xl shadow-md'>
                ...
                <div data-aos="zoom-in-down" className='bg-pink-100 p-4 rounded-xl shadow-md'>
                ...
                <div data-aos="fade-left" className='bg-pink-100 p-4 rounded-xl shadow-md'>
