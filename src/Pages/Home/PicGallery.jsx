        ...
        <div className='my-10'>
            ...
            <div>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-1/2 mx-auto">
                    <div data-aos="fade-right" className="aspect-w-1 aspect-h-1 border-pink-200  border-8 shadow-xl">
                        <img src="https://m.media-amazon.com/images/I/815MWn31kIL._SX569_.jpg" alt="Image 1" className="object-cover w-full h-full" />
                    </div>
                    <div>

                    </div>
                    <div data-aos="fade-left"  className="aspect-w-1 aspect-h-1 border-pink-200  border-8 shadow-xl">
                        <img src="https://m.media-amazon.com/images/I/71JdlF7JKIL._SX466_.jpg" alt="Image 2" className="object-cover w-full h-full" />
                    </div>
                    <div></div>
                    <div data-aos="zoom-in-down"   className="aspect-w-1 aspect-h-1 h-[100%] border-pink-200  border-8 shadow-xl">
                    ...
                    <div></div>
                    <div  data-aos="fade-right" className="aspect-w-1 aspect-h-1 h-[80%] border-pink-200  border-8 shadow-xl">
                    ...
                    <div data-aos="fade-left"  className="aspect-w-1 h-[80%] aspect-h-1 border-pink-200  border-8 shadow-xl">
