        ...
        <div className='my-10'>
            ...
            <div>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-1/2 mx-auto">
                    <div className="aspect-w-1 aspect-h-1 border-pink-200  border-8">
                    ...
                    <div></div>
                    <div className="aspect-w-1 aspect-h-1 h-[100%] border-pink-200  border-8">
                    ...
                    <div></div>
                    <div className="aspect-w-1 aspect-h-1 h-[80%] border-pink-200  border-8">
                    ...
                    <div className="aspect-w-1 h-[80%] aspect-h-1 border-pink-200  border-8">
